...
use Deprecator\LaravelMysqlSpatial\Types\GeometryInterface;
...
class GeometryCollectionTest extends BaseTestCase
{
    ...
    public function testInvalidArgumentExceptionNotArrayGeometries()
    {
        $this->assertException(
            ...
            'Deprecator\LaravelMysqlSpatial\Types\GeometryCollection must be a collection of Deprecator\LaravelMysqlSpatial\Types\GeometryInterface'
        );
        $geometrycollection = new GeometryCollection([
            $this->getPoint(),
            1,
    ...
    {
        $this->assertException(
            \Deprecator\LaravelMysqlSpatial\Exceptions\InvalidGeoJsonException::class,
