...
use Deprecator\LaravelMysqlSpatial\Types\GeometryCollection;
use Deprecator\LaravelMysqlSpatial\Types\LineString;
use Deprecator\LaravelMysqlSpatial\Types\MultiPoint;
use Deprecator\LaravelMysqlSpatial\Types\MultiPolygon;
use Deprecator\LaravelMysqlSpatial\Types\Point;
use Deprecator\LaravelMysqlSpatial\Types\Polygon;
...
class SpatialTest extends IntegrationBaseTestCase
{
    ...
    public function testSpatialFieldsNotDefinedException()
    {
        ...
        $this->assertException(\Deprecator\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException::class);
    ...
    public function testOrderBySpatialWithUnknownFunction()
    {
        ...
        $this->assertException(\Deprecator\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class);
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \Deprecator\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \Deprecator\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \Deprecator\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
